DATAFLOWS=nexmark_2 REPS=1 ./experiments/how_much/run.sh`stat` and `sha512sum`. There are two ways around that.
...
examples of Figure 5 of the paper.without the taxi download:
